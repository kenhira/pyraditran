...
! Description:  Modified from BDREF.f originally distributed in the DISORT 
!               package.
! ==============================================================================

! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! $Rev: 55 $ $Date: 2014-12-31 12:16:59 -0500 (Wed, 31 Dec 2014) $
! FORTRAN 77
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!       ** Hapke's BRDF model (times Pi/Mu0) (Hapke, B., Theory of reflectance
!       ** and emittance spectroscopy, Cambridge University Press, 1993, Eq.
!       ** 8.89 on page 233. Parameters are from Fig. 8.15 on page 231, expect
!       ** for w.)
...
! +--------------------------------------------------------------------
! Hapke "Theory of Reflectance and Emittance Spectroscopy" Chapter 10, Page 262
! Eq. (10.2).
! Version 3 fix: definition of phase angle / scattering angle see DISORT3
! paper Eqs. (25-26).
! +--------------------------------------------------------------------
      IMPLICIT NONE
      REAL MUP, MU, DPHI
...
!   DPHI:  relative azimuth to incident vector; (pi - dphi), sun-view relative
!          azimuth sun located at phi = 180, while incident solar beam located
!          at phi = 0
...
!   H0:    RPV BRDF parameter, control hot spot (back scattering direction)
!
!   Output:
!
!   BRDF:  RPV BRDF
...
!   refrac_index: BRDF parameter, refractive index of boundary media (water)
...
!     Shadowing effect (see Tsang, Kong, Shin, Theory of Microwave Remote
...
!   Input:
!
!   COS_THETA     absolute cosine of incident/reflected polar angle (positive)
