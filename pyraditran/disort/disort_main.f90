...
! Description:  Main file for running and interfacing the DISORT radiative 
!               transfer model. Modified from disotest.f90 originally 
!               distributed in the DISORT package.
! ==============================================================================
